...
function calculateSumTheme(num1: number, num2: number): number {
    return num1 + num2;
}
...
type MathOperationTheme = (a: number, b: number) => number;
...
// Example usage:
const addType: MathOperationTheme = (a: number, b: number): number => a + b;
...
const multiplyTheme = (num1: number, num2: number): number => num1 * num2;
